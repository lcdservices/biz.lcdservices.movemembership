 ...
 */
class CRM_LCD_MoveMembership_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_LCD_MoveMembership_Upgrader(
        'biz.lcdservices.movemembership',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_LCD_MoveMembership_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
